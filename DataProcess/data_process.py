...
# np.save('Data/Chinese_train_data.npy', WriteData)
# np.save('Data/Chinese_train_labels.npy', WriteDataLabels)
# np.save('Data/Chinese_test_data.npy', TestData)
# np.save('Data/Chinese_test_labels.npy', TestDataLabels)

print("[INFO] accessing MNIST...")
((trainData, trainLabels), (testData, testLabels)) = mnist.load_data()
'''
for i in range(len(trainData)):
    tmp = modify_img(trainData[i], trainData[i])
    tmp = cv2.resize(tmp, (28, 28))
    tmp = np.pad(tmp, ((3, 3), (3, 3)), 'constant')
    tmp = cv2.resize(tmp, (28, 28))
    trainData[i] = tmp

for i in range(len(testData)):
    tmp = modify_img(testData[i], testData[i])
    tmp = cv2.resize(tmp, (28, 28))
    tmp = np.pad(tmp, ((3, 3), (3, 3)), 'constant')
    tmp = cv2.resize(tmp, (28, 28))
    testData[i] = tmp
...
# np.save('Data/English_train_data.npy', trainData)
# np.save('Data/English_train_labels.npy', trainLabels)
# np.save('Data/English_test_data.npy', testData)
# np.save('Data/English_test_labels.npy', testLabels)
...
np.save("Data/mix_train_data_new.npy", trainData)
np.save("Data/mix_train_labels_new.npy", trainLabels)
np.save("Data/mix_test_data_new.npy", testData)
np.save("Data/mix_test_labels_new.npy", testLabels)
